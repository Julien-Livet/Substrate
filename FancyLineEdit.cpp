...
{
    setObjectName(QString("FancyLineEdit"));
    ...
    QIcon icon = QIcon::fromTheme(layoutDirection() == Qt::LeftToRight ?
                     ...
                     QIcon::fromTheme("edit-clear", QIcon(QLatin1String(":/Images/Images/Effacer_droite.png"))));
...
FancyLineEdit::FancyLineEdit(const QString &contents, QWidget *parent) :
...
IconButton *FancyLineEdit::iconButton() const
{
    return m_d->m_iconbutton;
}
